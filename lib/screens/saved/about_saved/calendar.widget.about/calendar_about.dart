...
class CalendarAbout extends StatefulWidget {
  const CalendarAbout({Key? key}) : super(key: key);

  @override
  _CalendarWidgetState createState() => _CalendarWidgetState();
}

class _CalendarWidgetState extends State<CalendarAbout> {
      ...
      children: [
        Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(top: getProportionScreenHeight(4)),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("From",
